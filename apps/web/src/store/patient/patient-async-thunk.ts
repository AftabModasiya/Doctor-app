...
export const getPatientByIdAsyncThunk = createAsyncThunk(
...
export const createPatientAsyncThunk = createAsyncThunk(
...
export const updatePatientAsyncThunk = createAsyncThunk(
...
export const deletePatientAsyncThunk = createAsyncThunk(
